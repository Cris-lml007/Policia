        ...
        <div class="container label">
            ...
            <table id="parent">
                ...
                <tbody>
                    ...
                    {{--                         <td>{{empty(explode(' ',$detail->supervisor->surname)[1]) ? ' ' : explode(' ',$detail->supervisor->surname)[1]}}</td> --}}
                    ...
                    {{--                         <td>{{empty(explode(' ',$detail->user->surname)[1]) ? ' ' : explode(' ',$detail->user->surname)[1]}}</td> --}}
